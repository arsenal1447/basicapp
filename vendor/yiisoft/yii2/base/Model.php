...
class Model extends Component implements IteratorAggregate, ArrayAccess, Arrayable
{
    ...
    public function validate($attributeNames = null, $clearErrors = true)
    {
        ...
        foreach ($this->getActiveValidators() as $validator) {
            file_put_contents('E:/log/1.txt', var_export($validator,true),FILE_APPEND);
            $validator->validateAttributes($this, $attributeNames);
        }
        $this->afterValidate();
       file_put_contents('E:/log/3.txt', var_export($this->afterValidate(),true),FILE_APPEND);

       file_put_contents('E:/log/2.txt', var_export(!$this->hasErrors(),true),FILE_APPEND);
    ...
    public function setAttributes($values, $safeOnly = true)
    {
        if (is_array($values)) {
            ...
            foreach ($values as $name => $value) {
                file_put_contents('E:/log/t.txt', var_export($name.'=>'.$value),FILE_APPEND);
